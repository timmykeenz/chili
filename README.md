...
**Award-Winning (2023) | Ghost Pepper Infused | Life-Altering**
...
2. **Push this code** to the repository:
   ...
   git init
   git add .
   git commit -m "Initial commit: A Chili to Spark Revenge"
   git branch -M main
...
├── styles.css      # All styling (fiery color palette!)
...
| Color | Hex | Usage |
|-------|-----|-------|
| Fire Red | `#e63946` | Primary accent |
| Fire Orange | `#ff6b35` | Secondary accent |
| Fire Yellow | `#ffc300` | Highlights |
...
- **Bangers** - Display headings (bold, fun)
- **Permanent Marker** - Accent text (handwritten feel)
- **Poppins** - Body text (clean, readable)
...
*Personal Chef Services: $100/hour (terms and conditions apply)*
